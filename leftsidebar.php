<div class="main-menu">
            ...
            <li class="menu-item">
              <a class="menu-link waves-effect" href="modulo_eventos_list.php">
               <span class="menu-icon"><i class="fa-regular fa-calendar-days"></i></span>                             <span class="menu-text"> 
                Eventos</span>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a class="menu-link waves-effect" href="modulo_entradas_list.php">
               <span class="menu-icon"><i class="fa-solid fa-id-card-clip"></i></span>                             <span class="menu-text"> 
                Entradas</span>
              </a>
            </li>
              <li class="menu-item">
              <a class="menu-link waves-effect" href="modulo_participantes_list.php">
               <span class="menu-icon"><i class="fa-solid fa-people-line"></i></span>                             <span class="menu-text"> 
                Participantes</span>
              </a>
            </li>
