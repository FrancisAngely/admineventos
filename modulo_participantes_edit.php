                        ...
                        <form action="#" method="post" enctype="multipart/form-data" id="form1">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="apellidos" name="apellidos"
                                    placeholder="apellidos" value="<?php echo $part["apellidos"]; ?>">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nif_nie" name="nif_nie"
                                    placeholder="nif_nie" value="<?php echo $part["nif_nie"]; ?>">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="telefono" name="telefono"
                                    placeholder="telefono" value="<?php echo $part["telefono"]; ?>">
                            </div>
