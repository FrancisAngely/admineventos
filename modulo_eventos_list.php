            ...
            <div class="px-3">
                <div class="container-fluid">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <!--
                SELECT `id`, `evento`, `fecha`, `file_evento`, `direccion`, 
                `id_provincias`, `id_localidades`, `cp`, `hora_comienzo`, 
                `descripcion`, `created_at`, `updated_at` FROM `eventos` WHERE 1
                -->
                            <td><?php echo $e["id1"]; ?></td>
                            <td><?php echo $e["evento"]; ?></td>
                            <td><?php echo $e["fecha"]; ?></td>
                            <td><?php echo $e["id_localidades"]; ?></td>
                            <td><?php echo $e["id_provincias"]; ?></td>

                            <td><a href="modulo_eventos_edit.php?id=<?php echo $e["id1"]; ?>"><i
                                        class="fa-solid fa-pen-to-square fa-2x"></i></a>
                                &nbsp;&nbsp;
                                <a href="#" data-id="<?php echo $e["id1"]; ?>" class="borrar"><i
